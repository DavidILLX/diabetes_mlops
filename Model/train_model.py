...
def create_new_experiment():
    ...
    experiments_sorted = sorted(
        experiments, key=lambda x: x.creation_time, reverse=True
    )
    ...
    try:
        if latest_experiment:
            ...
            logging.info(
                f"Experiment '{latest_experiment}' (ID: {latest_experiment.experiment_id}) was archived."
            )
        else:
    ...
    objectives = {
        ...
        "random_forest": (
            rf_objective,
            {
                ...
                "max_depth": hp.choice(
                    "max_depth",
                    [None] + [scope.int(hp.quniform("max_depth_val", 5, 50, 1))],
                ),
                ...
                "min_samples_leaf": scope.int(
                    hp.quniform("min_samples_leaf", 1, 20, 1)
                ),
                ...
                "max_leaf_nodes": hp.choice(
                    "max_leaf_nodes",
                    [None] + [scope.int(hp.quniform("max_leaf_nodes_val", 10, 100, 1))],
                ),
